...
tabuQueue::Queue{Array{Array{Int64,1},1}}, bestObjVal::Float64, demands::Array{Int64,2},
    ...
    for saving in savings
        ...
        elseif feasibility == "feasible"
            ...
            elseif feasibility == "feasible"
                ...
                checkRoutes[currentTruck] = tempRoute1
                checkRoutes[routeNum] = tempRoute2

                if in(checkRoutes, tabuQueue)
                    # Aspiration check
                    checkObj = currentObjVal - saving[1]
