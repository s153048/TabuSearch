...
include("functions/TABU/runTABU_operatorAnalysis.jl")
...
function operatorAnalysis()
    ...
    for k in params
        ...
        bestRoutes, bestObjVal, iterations, operatorCount, intraRval, intraTval, interRval, interEval =
        runTABU_operatorAnalysis(truckRoutes, objVal, k, runtime,
    ...
    writedlm("output/operatorCount.csv", operatorCount, ',')
    writedlm("output/intraRval.csv", intraRval, ',')
    writedlm("output/intraTval.csv", intraTval, ',')
    writedlm("output/interRval.csv", interRval, ',')
    writedlm("output/interEval.csv", interEval, ',')
end
