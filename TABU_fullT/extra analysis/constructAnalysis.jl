...
function constructAnalysis()
    ...
    df = DataFrame(i = Int64[], bnDist = Float64[], bnVehi = Int64[],
    ...
    for i in params
        ...
        truckRoutes = insertionHeuristic(parameters[i], name, vehicles,
        ...
        runTABU(truckRoutes, objVal, 75, runtime,
        ...
        push!(df, (i, bnDist, bnVehi, tabuDist, tabuVehi, dDist, dVehi,
    ...
    CSV.write("output/constructAnalysis.csv", df)
end
