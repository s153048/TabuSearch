...
tabuQueue::Queue{Tuple}, bestObjVal::Float64, servicetimes::Array{Int64,2})
    ...
    for saving in savings
        ...
        elseif feasibility == "feasible"
            ...
            move1 = (customer, currentTruck, i)
            move2 = (iDX, currentTruck, u)
            if in(move1, tabuQueue) || in(move2, tabuQueue)
                continue
            else
                # Store new tabuMove
                tabuMoves = [(customer, currentTruck, u) (iDX, currentTruck, i)]
